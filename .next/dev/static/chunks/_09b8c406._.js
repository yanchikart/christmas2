...
"[project]/components/wishes-wall.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WishesWall() {
    ...
    const [isMusicPlaying, setIsMusicPlaying] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WishesWall.useEffect": ()=>{
            // Начальная загрузка
            const loadWishes = {
                "WishesWall.useEffect.loadWishes": async ()=>{
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('wishes').select('*').order('created_at', {
                        ascending: false
                    });
                    setWishes(data || []);
                }
            }["WishesWall.useEffect.loadWishes"];
            loadWishes();
            // Реалтайм — новые пожелания появляются у всех автоматически
            const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('wishes').on('postgres_changes', {
                event: 'INSERT',
                schema: 'public',
                table: 'wishes'
            }, {
                "WishesWall.useEffect.channel": (payload)=>{
                    setWishes({
                        "WishesWall.useEffect.channel": (prev)=>[
                                payload.new,
                                ...prev
                            ]
                    }["WishesWall.useEffect.channel"]);
                }
            }["WishesWall.useEffect.channel"]).subscribe();
            return ({
                "WishesWall.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].removeChannel(channel).catch(console.error);
                }
            })["WishesWall.useEffect"];
        }
    }["WishesWall.useEffect"], []);
    ...
    const handleSubmit = async (e)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('wishes').insert({
            name: name.trim() || null,
...
_s(WishesWall, "l6L9rP2Xqc2Dn30/HT8jSp7Yap8=");
_c = WishesWall;
var _c;
__turbopack_context__.k.register(_c, "WishesWall");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_09b8c406._.js.map